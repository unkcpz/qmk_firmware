 ...
 */
    [_FN1] = LAYOUT_ansi_61(
        ...
        _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______,  KC_HOME,  KC_END, KC_PGUP, _______, _______,          _______,
        _______,           KC_GRV,  _______, _______, _______, _______, _______, _______,  KC_PGDN, _______, _______,          _______,
        _______, _______, _______,                            _______,                              _______, _______, _______, _______
    ), 
/* Keymap 4: FN2 layer
 *
