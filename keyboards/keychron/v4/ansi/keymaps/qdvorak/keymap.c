 ...
 * `--------+------+------+------+------+------------------+------+------+------+------+------------------'
 * | Caps   | LWin |  LAlt|                       Space                    | RAlt | _FN1 |  _FN3 |  RCtrl | 
 * `------------------------------------'-----------------------------------------------------------------.
 */
    [MAC_BASE] = LAYOUT_ansi_61(
        KC_ESC,  KC_1,     KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_LBRC,  KC_RBRC,  KC_BSPC,
        KC_TAB,  KC_QUOT,  KC_COMM, KC_DOT,  KC_P,    KC_Y,    KC_F,    KC_G,    KC_C,    KC_R,    KC_L,     KC_BSLS,  KC_EQL,   KC_SLSH,
        KC_LCTL, KC_A,     KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,     KC_MINS,             KC_ENT,
        KC_LSFT,           KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,        KC_Z,            KC_RSFT,
        KC_CAPS, KC_LOPT,  KC_LCMD,                            KC_SPC,                             KC_RCMD,  MO(_FN1), MO(_FN3), KC_RCTL
    ),
